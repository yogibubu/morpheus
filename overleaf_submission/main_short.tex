...
The refinement engine and statistical diagnostics underlying the benchmarks
reported here, together with the corresponding input/output and audit files,
are available in the Supporting Information. \texttt{MORPHEUS} is being
integrated into the broader \texttt{MATRIX} framework. The coordinate-generation
module remains under active development for intermolecular systems and other
special-coordinate classes and is planned to be made available with the
