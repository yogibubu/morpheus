...
Within MATRIX, ORACLE supplies the frozen topology, point-group operations and
equivalence classes, while SMITH constructs the corresponding SONIC coordinate
contract; MORPHEUS formulates and solves the inverse model without repeating
either molecular perception or coordinate construction.
...
\texttt{SMITH} as \texttt{SONIC} coordinate contracts. They are documented in
