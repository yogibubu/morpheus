...
graphical audit is given explicitly in the Supporting Information: Table~S3
lists the generated working-coordinate models and active dimensions, while
Table~S8 shows that imported legacy MSR/MSROT numerical models are reproduced
...
Table~S6 reports the corresponding final-validation runs explicitly, including
