...
MORPHEUS delegates that operation to a dedicated geometry-realization service
rather than owning a second Wilson-B inversion algorithm.
...
SONIC methodological preprint. Its arXiv identifier will be inserted in
