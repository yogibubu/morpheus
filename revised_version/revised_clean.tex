...
\rev{In the complete workflow, different tools perceive the molecular topology
and build non-redundant internal coordinates, which are used by MORPHEUS to
...
The complete sequence is summarized in Figure~\ref{fig:glycine-algorithmic-flow}.
...
The testosterone demonstration extends this logic to the largest system considered here. It does not claim a complete
...
MORPHEUS 0.1.0rc8 source, runnable examples, benchmark inputs and outputs, and
final-validation data are publicly available in the revision-pinned repository
of Ref.~\citenum{Barone2026MORPHEUSSoftware}. The intramolecular primitive
