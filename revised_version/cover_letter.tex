...
MORPHEUS uses a rank-controlled minimum-norm or nonlinear
internal-to-Cartesian realization, without introducing a second Wilson-B
inversion algorithm.
...
SMITH/SONIC methodological preprint, publicly available as
