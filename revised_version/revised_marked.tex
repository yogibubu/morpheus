...
the revision-pinned MORPHEUS 0.1.0rc8 repository of
Ref.~\citenum{Barone2026MORPHEUSSoftware}.} The benchmark input/output files, numerical audit trails, and statistical
diagnostics are documented in the Supporting Information. \rev{The standalone MORPHEUS 0.1.0rc8 release contains the source, runnable examples, benchmark
...
contracts used here. These files are sufficient to reproduce the reported
applications; no separate methodological package is required.} The
